...
def main():
    ...
    with st.sidebar:
        ...
        if st.session_state["FreeChatReloadFlag"] == True:
            ...
            st.session_state["FreeChatSetting"] = {"model": aa_llm_model, "max_tokens": aa_max_resp, "temperature": float(aa_temperature)}
    ...
    for message in st.session_state["FreeChatMessages"]:
