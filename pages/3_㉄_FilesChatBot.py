...
def main():
    ...
    if "FileChat" not in st.session_state:
        chat = ChatBot(work_path + "/workDir",
                       work_path + "/Output",
                       work_path)
    ...
    # main page
        with tab1:
                ...
                if file_paths is not None or len(file_paths) > 0:
                    ...
                    with st.spinner('Reading file'):
                        ...
                        for file_path in file_paths:
                            uploaded_paths.append(os.path.join(work_path + "/workDir", file_path.name))
            ...
            index_file_list = st.session_state["FileChat"].get_all_files_list("./Output", "faiss")
